...
const KEY_RADIUS = 14
const ROW_GAP = 18
const KEY_SHADOW = '0 1px 0 var(--ios-key-shadow)'
...
export function Keyboard() {
  return (
    <div
      ...
      style={{
        background: 'var(--ios-keyboard-bg)',
        paddingTop: 18,
        paddingBottom: 8,
        paddingLeft: 8,
        paddingRight: 8,
    ...
    >
      ...
      {/* Row 4 — 123, globe (square), space, return */}
      <div className="flex" style={{ gap: KEY_GAP }}>
